                ...
                <AccordionContent>
                  <div className="space-y-4">
                    {clientOrders.length > 0 && (
                      <div className="space-y-2">
                        {clientOrders.map((order) => (
                          <div key={order.orderId} className="border rounded-md p-3 flex justify-between items-center">
                            <div>
                              <div className="font-medium">{order.orderId}</div>
                              <div className="text-sm text-muted-foreground">
                                {order.date} - {order.location} - ${order.price.toFixed(2)}
                              </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => setNewOrder({ ...newOrder, price: Number.parseFloat(e.target.value) })}
              ...
              <AccordionItem value="deposits">
                <AccordionTrigger>
                  <div className="flex items-center">
                    ...
                    Deposits ({clientDeposits.length})
                  </div>
                </AccordionTrigger>
                <AccordionContent>
                  <div className="space-y-4">
                    {clientDeposits.length > 0 && (
                      <div className="space-y-2">
                        {clientDeposits.map((deposit) => (
                          ...
                          >
                            <div>
                              <div className="font-medium">{deposit.depositId}</div>
                              <div className="text-sm text-muted-foreground">
                                {deposit.date} - ${deposit.amount.toFixed(2)}
                              </div>
                    ...
                    <div className="border rounded-md p-4 space-y-4">
                      <h4 className="font-medium">Add New Deposit</h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewDeposit({ ...newDeposit, amount: Number.parseFloat(e.target.value) })
                            }
                        ...
                        <div className="space-y-2 md:col-span-2">
                          <Label htmlFor="depositPaymentMode">Payment Mode</Label>
                          <Select
                            value={newDeposit.paymentMode as string}
                            onValueChange={(value) => setNewDeposit({ ...newDeposit, paymentMode: value })}
                          >
                            <SelectTrigger id="depositPaymentMode">
              ...
              <AccordionItem value="withdrawals">
                <AccordionTrigger>
                  <div className="flex items-center">
                    ...
                    Withdrawals ({clientWithdrawals.length})
                  </div>
                </AccordionTrigger>
                <AccordionContent>
                  <div className="space-y-4">
                        ...
                        {clientWithdrawals.map((withdrawal) => (
                          ...
                          >
                            <div>
                              ...
                              <div className="text-sm text-muted-foreground">
                                {withdrawal.date} - ${withdrawal.amount.toFixed(2)}
                              </div>
                              <Badge className={getPaymentModeColor(withdrawal.paymentMode)}>
                    ...
                    <div className="border rounded-md p-4 space-y-4">
                      <h4 className="font-medium">Add New Withdrawal</h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewWithdrawal({ ...newWithdrawal, amount: Number.parseFloat(e.target.value) })
                            }
                            placeholder="Enter amount"
                          />
                        </div>
                        ...
                        <div className="space-y-2 md:col-span-2">
                          <Label htmlFor="withdrawalPaymentMode">Payment Mode</Label>
                          <Select
                            value={newWithdrawal.paymentMode as string}
                            onValueChange={(value) => setNewWithdrawal({ ...newWithdrawal, paymentMode: value })}
                          >
                            <SelectTrigger id="withdrawalPaymentMode">
                              <SelectValue placeholder="Select payment mode" />
                            </SelectTrigger>
                            <SelectContent>
                              <SelectItem value="Crypto">Crypto</SelectItem>
                      ...
                      <Button onClick={handleAddWithdrawal} className="w-full">
                        <Plus className="h-4 w-4 mr-2" />
                        Add Withdrawal
                      </Button>
                    </div>
